    ...
    <h-panel>
        ...
        <div class="table">
            ...
            <div class="table-header">
                ...
                <div class="table-header-cell f-1">文件大小</div>
            ...
            <div class="table-footer">
                ...
                <span class="action m-l-16" @click="removeRecordAsync">还原</span>
                <span class="action action--warning m-l-16" @click="onCleanAsync">彻底删除</span>
